...
import { getErc20ApprovalsOperation, GetErc20ApprovalsRequest } from './getErc20ApprovalsOperation';

describe('getErc20ApprovalsOperation', () => {
  ...
  it('serializeRequest() serializes correctly and deserializeRequest() deserializes correctly', () => {
    ...
    const serializedRequest = getErc20ApprovalsOperation.serializeRequest(request, core);
    ...
    const deserializedRequest = getErc20ApprovalsOperation.deserializeRequest(serializedRequest, core);
