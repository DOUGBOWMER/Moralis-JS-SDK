...
import { NftApprovalsProcessor } from './NftApprovalsProcessor';

describe('NftApprovalsProcessor', () => {
      ...
      ERC721: [
        {
          ...
          logIndex: '361',
          contract: '0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d',
          owner: '0x0a1ad77312d36459179ad622c2a8a6280cc79419',
  ...
  it('processes correctly', () => {
    const processor = new NftApprovalsProcessor(new CollectionNameBuilder());
